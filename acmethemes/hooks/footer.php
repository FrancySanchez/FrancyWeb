                    ...
                    <div class="container">
                        <div class="row">
                            <div class="footer-columns">
                                ...
                                <?php if( is_active_sidebar( 'read-more-footer-top-col-two' ) ) : ?>
                                    <div class="footer-sidebar <?php echo esc_attr( $footer_top_col );?>">
                                        <?php dynamic_sidebar( 'read-more-footer-top-col-two' ); ?>
                                    </div>
                                <?php endif; ?>

                                <?php if( is_active_sidebar( 'read-more-footer-top-col-three' ) ) : ?>
                                    <div class="footer-sidebar <?php echo esc_attr( $footer_top_col );?>">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="footer-copyright border text-center">
                                <div class="site-info">
                                Made with ♥ using WordPress | <a href="http://www.digitalocean.com/?refcode=d16347dce861" target="blank"> Hosted by DigitalOceans</a>
                                  <?php 
